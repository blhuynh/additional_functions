...
%
%   Steve Wallace (Duke BME) Edited Output Text from 'Time' to 'Repeated Condition' 
%   and 'Subjects (matching)' to 'Subjects'
%
...
if s > 1
    ...
    table = { 'Source' 'SS' 'df' 'MS' 'F' 'Prob>F'
        'Repeated Condition'  ssT t-1 msT FT pT
        'Group' ssG s-1 msG FG pG
        'Interaction' ssGT (s-1)*(t-1) msGT FGT pGT
        'Subjects' ssSG n-s msSG FSG pSG
